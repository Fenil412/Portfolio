                ...
                <VerticalTimeline animate={true} lineColor="#915eff">
                    {experiences.map((experience, index) => (
                        ...
                        >
                            ...
                            >
                                <div className="relative group bg-tertiary p-6 rounded-xl overflow-hidden border border-white/10 hover:border-[#915eff]/50 transition-all duration-300 shadow-card hover:shadow-[0_0_30px_rgba(145,94,255,0.25)]">
                                    ...
                                    <div className="relative z-10">
                                        <h3 className="text-white text-[24px] font-bold group-hover:text-[#915eff] transition-colors duration-300">
                                            {experience.title}
                                        </h3>
                                        <p className="text-secondary text-[16px] font-semibold" style={{ margin: 0 }}>
                                            {experience.company_name}
                                        </p>
                                        <p className="text-secondary opacity-75 text-[12px] mt-1 italic flex items-center gap-1">
                                        ...
                                        {experience.skills && (
                                            <div className="mt-4 flex flex-wrap gap-2 pt-4 border-t border-white/5">
                                                {experience.skills.map((skill, idx) => (
                                                    <span key={idx} className="text-[12px] bg-gradient-to-r from-[#915eff]/10 to-purple-900/10 text-gray-300 hover:text-white px-2.5 py-1 rounded-md border border-[#915eff]/20 hover:border-[#915eff] transition-all cursor-default">
                                                        {/* text-gray-300 is slate-600 in light mode via css override */}
                                                        #{skill}
                                                    </span>
                                                ))}
                                            </div>
